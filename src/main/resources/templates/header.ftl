...
<head>
    ...
    <link rel="search" type="application/opensearchdescription+xml" href="#"
          title="问答">
    <link rel="stylesheet" type="text/css" href="${ctx}/styles/bootstrap.min.css">
    <style>
...
<div role="navigation" class="zu-top">
    <div class="zg-wrap modal-shifting clearfix" id="zh-top-inner">
        <a href="${ctx}/" class="zu-top-link-logo" id="zh-top-link-logo" data-za-c="view_home" data-za-a="visit_home"
           data-za-l="top_navigation_zhihu_logo">问答</a>
        <div class="top-nav-profile">
            <#if user??>
                <a href="${ctx}/user/${user.id!''}" class="zu-top-nav-userinfo " id=":0" role="button" aria-haspopup="true"
                ...
                <ul class="top-nav-dropdown" id="top-nav-profile-dropdown" aria-labelledby=":0">
                    ...
                    <li>
                        <a href="${ctx}/msg/list" tabindex="-1" id=":2">
        ...
        <div id="zg-top-nav" class="zu-top-nav">
            <ul class="zu-top-nav-ul zg-clear">
                ...
                <li class="zu-top-nav-li " id="zh-top-nav-explore">
                    <a class="zu-top-nav-link" href="${ctx}/pullfeeds">发现</a>
                </li>
                <#if user??>
            ...
            <div class="zu-top-nav-live zu-noti7-popup zg-r5px no-hovercard" id="zh-top-nav-live-new" role="popup"
                ...
                <div class="zu-top-nav-live-inner zg-r5px">
                    ...
                    <div class="zm-noti7-popup-footer">
                        <a href="#" class="zm-noti7-popup-footer-all zg-right">查看全部
                            »</a>
                        <a href="#" class="zm-noti7-popup-footer-set"

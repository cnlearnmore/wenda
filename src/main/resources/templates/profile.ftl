<#include "header.ftl"><link rel="stylesheet" href="../styles/index.css">
                    ...
                    <div id="zh-profile-follows-list">
                        <div class="zh-general-list clearfix">
                            <div class="zm-profile-card zm-profile-section-item zg-clear no-hovercard">
                                <div class="zg-right">
                                    <#if profileUser.followed??>                                    <button class="zg-btn zg-btn-unfollow zm-rich-follow-btn small nth-0
                                    js-follow-user" data-status="1" data-id="${profileUser.user.id!''}">取消关注</button>
                                    <#else>                                    <button class="zg-btn zg-btn-follow zm-rich-follow-btn small nth-0
            ...
            <div class="zu-main-content-inner">
                ...
                <div class="zu-main-feed-con navigable" data-feedtype="topstory" id="zh-question-list">
                    <div id="js-home-feed-list" class="zh-general-list topstory clearfix">
                        <#list vos as vo>                        <div class="feed-item folding feed-item-hook feed-item-2
...
<#include "js.ftl"><script type="text/javascript" src="/scripts/main/site/profile.js"></script>
<#include "footer.ftl">
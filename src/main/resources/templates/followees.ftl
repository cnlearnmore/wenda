<#include "header.ftl"><link rel="stylesheet" href="../../styles/result.css">
                ...
                <div class="zm-profile-section-list">
                    <div id="zh-profile-follows-list">
                        <div class="zh-general-list clearfix">
                            <#list followees as vo>                            <div class="zm-profile-card zm-profile-section-item zg-clear no-hovercard">
                                <#if vo.followed?? >                                <div class="zg-right">
...
<#include "js.ftl"><script type="text/javascript" src="/scripts/main/site/follow.js"></script>
<#include "footer.ftl">
        ...
        <div class="zu-main-content-inner">
            ...
            <div class="zm-side-section">
                <div class="zm-side-section-inner" id="zh-question-side-header-wrap">
                    <#if followed?? && followed == true>                    <button class="follow-button zg-follow js-follow-question zg-btn-white" data-id="${question.id!''}"
                            data-status="1">
                        取消关注
                    </button>
                    <#else>                    <button class="follow-button zg-follow js-follow-question zg-btn-green" data-id="${question.id!''}">
                        关注问题
                    </button>
                    </#if>                    <div class="zh-question-followers-sidebar">
            ...
            <div id="zh-question-answer-wrap" data-pagesize="10" class="zh-question-answer-wrapper navigable"
                ...
                <#list comments as comment>                <div class="zm-item-answer  zm-item-expanded js-comment">
                    ...
                    <div class="zm-votebar goog-scrollfloater js-vote" data-id="${comment.comment.id!''}">
                        <#if comment?? && comment.liked?? && (comment.liked>0)>                        <button class="up js-like pressed" title="赞同">
                        <#else>                        <button class="up js-like" title="赞同">
                        </#if>                            <i class="icon vote-arrow"></i>
                            <span class="count js-voteCount">${comment.likeCount!''}</span>
                            <span class="label sr-only">赞同</span>
                        </button>

                        <#if comment?? && comment.liked?? && (comment.liked < 0)>                        <button class="down js-dislike pressed" title="反对，不会显示你的姓名">
                        <#else>                        <button class="down js-dislike" title="反对，不会显示你的姓名">
                        </#if>                            <i class="icon vote-arrow"></i>
                    ...
                    <div class="zm-item-meta answer-actions clearfix js-contentActions">
                        <div class="zm-meta-panel">
                            <a itemprop="url" class="answer-data-link meta-item" target="_blank" href="">发布于${comment.comment.createdDate?string('yyyy-MM-dd HH:mm:ss')}</a>
